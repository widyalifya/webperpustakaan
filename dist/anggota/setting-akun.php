...
session_start();
    ...
    include '../../config/database.php';
    $query = mysqli_query($kon, "SELECT * FROM pengguna where kode_pengguna='$kode_anggota'");
...
<input name="kode_pengguna" value="<?php echo $kode_anggota; ?>" type="hidden" class="form-control">
    <div class="row">
        <div class="col-sm-6">
